...
export default function ProfileForm({
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const data: ProfileFormData = {
      ...
      aws_secret_access_key: (form.querySelector("#aws_secret_access_key") as HTMLInputElement)
        .value,
      ...
      direct_session_token:
        (form.querySelector("#direct_session_token") as HTMLInputElement)?.value || undefined,
      aws_session_token:
        (form.querySelector("#aws_session_token") as HTMLTextAreaElement)?.value || undefined,
    };
    onSubmit(data);
    form.reset();
  ...
  return (
    <Form onSubmit={handleSubmit} className="form-modern">
      <Form.Group className="mb-3">
        ...
        <Form.Control id="name" name="name" placeholder="e.g., production, development" required />
      </Form.Group>
