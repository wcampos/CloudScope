...
import { FaServer, FaDatabase, FaMemory, FaArchive, FaNetworkWired, FaEnvelope, FaGlobe, FaPlug, FaCogs, FaFolder, FaChevronDown, FaChevronRight } from 'react-icons/fa';
      ...
      {entries.map(([serviceName, items]) => {
        ...
        return (
          <div key={serviceName} className="resource-card">
            ...
            >
              <h3 className="resource-title" style={{ margin: 0, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                {isExpanded ? (
