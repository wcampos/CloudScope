        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
            ...
            <span style={{ fontSize: "0.75rem", color: "var(--cs-gray-500)" }}>
              Auto-refresh every {HEALTH_CHECK_INTERVAL_MINUTES}{" "}
              {HEALTH_CHECK_INTERVAL_MINUTES === 1 ? "minute" : "minutes"}
            </span>
            {(() => {
              ...
              return cacheHealth ? (
                ...
                >
                  Cache: {cacheOk ? "✓" : "—"}{" "}
                  {cacheOk ? "Redis" : cacheHealth.status === "unhealthy" ? "Unavailable" : ""}
                </span>
              ) : null;
            })()}
            <button
            ...
            {[
              ...
              <Col key={tech.name} xs={6} sm={4} md={3}>
                ...
                >
                  ...
                  <span
                    style={{ fontSize: "0.75rem", color: "var(--cs-gray-400)", marginLeft: "auto" }}
                  >
                    {tech.version}
                  </span>
                </div>
